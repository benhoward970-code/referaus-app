  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <button onClick={onClose} className="absolute top-4 right-4 text-ink-400 hover:text-gray-600 transition-colors">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required value={form.name} onChange={e => updateForm({ name: e.target.value })}
                      className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-line-200 text-ink-900 placeholder-gray-400 text-sm focus:outline-none focus:border-blue-500 transition-colors" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select value={form.service} onChange={e => updateForm({ service: e.target.value })}
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-line-200 text-ink-700 text-sm focus:outline-none focus:border-blue-500 transition-colors appearance-none">
                ...
                <div>
                  ...
                  <textarea required rows={4} value={form.message} onChange={e => updateForm({ message: e.target.value })}
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-line-200 text-ink-900 placeholder-gray-400 text-sm focus:outline-none focus:border-blue-500 transition-colors resize-none" />
                </div>
