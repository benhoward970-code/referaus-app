...
export const blogPosts: BlogPost[] = [
  ...
  {
    "slug": "ndis-support-coordination-explained",
    "title": "NDIS Support Coordination: What It Is and Why You Need It",
  ...
  },
  {
    ...
    "content": "## Registered vs Unregistered NDIS Providers\n\nNot all NDIS providers need to be registered with the NDIS Quality and Safeguards Commission. The key difference is that registered providers can work with all NDIS participants, while unregistered providers can only work with participants who self-manage or have a plan manager.\n\n**Registered providers** must meet NDIS Practice Standards, undergo regular audits, and comply with the NDIS Code of Conduct. In return, they can accept NDIA-managed participants and claim directly from the NDIA portal.\n\n**Unregistered providers** have fewer regulatory requirements but can only work with self-managed or plan-managed participants. They still must comply with the NDIS Code of Conduct.\n\n## Steps to Register as an NDIS Provider\n\n**Step 1: Understand the Requirements.** Review the NDIS Practice Standards relevant to your registration groups. These standards cover governance, risk management, service delivery, and participant rights.\n\n**Step 2: Complete an Application.** Apply through the NDIS Commission portal at ndiscommission.gov.au. You will need to specify which registration groups you are applying for.\n\n**Step 3: Undergo an Audit.** Depending on your registration groups, you will need either a verification audit (simpler, for lower-risk supports) or a certification audit (more comprehensive, for higher-risk supports like SIL or behaviour support).\n\n**Step 4: Meet Worker Screening Requirements.** All workers must have an NDIS Worker Screening Check. This is separate from a Working With Children Check.\n\n**Step 5: Maintain Compliance.** Registration is not a one-time event. You must maintain compliance with Practice Standards, report incidents, manage complaints, and undergo regular re-audits.\n\n## Costs of Registration\n\nAudit costs vary significantly depending on the size of your organisation and the registration groups you apply for. Verification audits typically cost between $3,000 and $8,000. Certification audits can cost between $10,000 and $30,000 or more for large organisations.\n\n## List Your Business on ReferAus\n\nWhether registered or unregistered, you can list your NDIS provider business on ReferAus for free. Get found by participants in the Hunter Region, manage reviews, and grow your business."
  },
  {
    "slug": "hunter-region-ndis-providers-guide",
    "title": "The Ultimate Guide to NDIS Providers in the Hunter Region",
    ...
    "content": "## NDIS in the Hunter Region\n\nThe Hunter Region is home to a diverse and growing network of NDIS providers serving participants across Newcastle, Lake Macquarie, Maitland, Cessnock, Port Stephens, Singleton, and surrounding areas. With over 15,000 NDIS participants in the region, there is strong demand for quality disability supports.\n\n## Newcastle\n\nAs the largest city in the Hunter, Newcastle has the highest concentration of NDIS providers. You will find a full range of services including allied health clinics in the CBD and Charlestown, support coordination services throughout the city, community access programs in Newcastle East, Merewether, and Hamilton, SIL providers in suburban areas, and specialist therapy services at John Hunter Hospital precinct.\n\n## Lake Macquarie\n\nLake Macquarie has seen significant growth in NDIS providers, particularly in Charlestown, Belmont, and Toronto. The area offers community access programs centred around the lake foreshore, allied health services in Glendale and Cardiff, and growing SDA developments in newer suburbs.\n\n## Maitland\n\nMaitland serves as a hub for the upper Hunter, with providers covering Maitland, Cessnock, Kurri Kurri, and Branxton. Services include support coordination, daily living support, and therapy services. The Heritage area has several established providers.\n\n## Finding the Right Provider\n\nWith so many options, finding the right provider can be overwhelming. That is why we built ReferAus. Our directory lets you search by service type and location, compare providers side by side, read reviews from real participants, and contact providers directly.\n\nWe focus specifically on the Hunter Region because we believe local knowledge matters. A directory that tries to cover all of Australia cannot give you the depth of information you need about providers in your area.\n\n## Getting Started\n\nVisit our provider directory to search for NDIS services in your area. Filter by service type, suburb, and rating to find providers that match your needs. All searches are free for participants."
  }
];
