...
function Toggle({ checked, onChange, disabled }: { checked: boolean; onChange?: (v: boolean) => void; disabled?: boolean }) {
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 focus-visible:ring-offset-2 ${checked ? 'bg-blue-600' : 'bg-gray-200'} ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
    >
      <span
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto">
        <nav className="text-xs text-ink-400 mb-8 flex items-center gap-1.5">
          <Link href="/" className="hover:text-ink-700 transition-colors">Home</Link>
          <span>/</span>
          <span className="text-ink-700">Cookie Preferences</span>
        </nav>

        <h1 className="text-3xl font-black tracking-tight text-ink-900 mb-2">Cookie Preferences</h1>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="card-flat p-6">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <span className="text-base font-bold text-ink-900">Essential Cookies</span>
          ...
          <div className="card-flat p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-base font-bold text-ink-900">Analytics Cookies</span>
          ...
          <div className="card-flat p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-base font-bold text-ink-900">Marketing Cookies</span>
        ...
        <div className="mt-10 pt-8 border-t border-line-100 text-sm text-ink-400 space-y-1">
