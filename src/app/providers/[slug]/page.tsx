  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6">
      <div className="max-w-5xl mx-auto">
        <Link href="/providers" className="inline-flex items-center gap-2 text-sm text-white/40 hover:text-white/70 mb-8 transition-colors">
          ? Back to providers
        </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="glass rounded-2xl p-6 sticky top-24">
              ...
              <button className="w-full py-3 rounded-xl glass hover:bg-white/[0.08] text-white font-medium text-sm transition-all mb-6">
                Book Appointment
              </button>
