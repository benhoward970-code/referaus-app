    ...
    <div className="min-h-screen bg-white">
      <section className="pt-28 pb-16 px-4 sm:px-6 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-ink-900 mb-5">
            The easiest way to find<br /><span className="text-blue-600">registered providers</span> for your clients
          </h1>
          <p className="text-ink-500 text-lg sm:text-xl max-w-2xl mx-auto mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/providers" className="inline-flex items-center justify-center gap-2 bg-white border border-line-200 hover:border-blue-300 text-ink-700 hover:text-blue-600 font-semibold px-7 py-3.5 rounded-xl transition-colors text-base">
              Browse Providers Now
            </Link>
          </div>
          <p className="text-xs text-ink-400 mt-3">No cost. No obligation. Always free for Support Coordinators.</p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 py-12">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-black text-ink-900 mb-2 text-center">Built for how you actually work</h2>
          <p className="text-ink-500 text-center mb-10">Tools that respect your time and your clients trust.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 rounded-2xl p-6 border border-line-100">
              ...
              <h3 className="font-bold text-ink-900 mb-2">Instant provider search</h3>
              <p className="text-sm text-ink-500 leading-relaxed">Search by service type, suburb, and registration status. Find registered options for your client in seconds.</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 border border-line-100">
              <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center mb-4">
              ...
              <h3 className="font-bold text-ink-900 mb-2">Shareable referral links</h3>
              <p className="text-sm text-ink-500 leading-relaxed">Send clients a personalised ReferAus link pre-filtered to services and location they need. No confusion.</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 border border-line-100">
              <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center mb-4">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="#2563eb"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" /></svg>
              </div>
              <h3 className="font-bold text-ink-900 mb-2">Registration-verified providers</h3>
              <p className="text-sm text-ink-500 leading-relaxed">Every provider with a Verified or Registration Ready badge has confirmed their status. Refer with confidence after July 2026.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 py-14 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-black text-ink-900 mb-2 text-center">How it works</h2>
          <p className="text-ink-500 text-center mb-10">Three steps. Completely free.</p>
          <div className="space-y-6">
            <div className="flex gap-5 items-start">
              ...
              <div>
                <h3 className="font-bold text-ink-900 mb-1">Create your free SC account</h3>
                <p className="text-sm text-ink-500 leading-relaxed">Sign up with your name and email. No credit card, no commitment. We verify you as a Support Coordinator to unlock SC-only features.</p>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              ...
              <div>
                <h3 className="font-bold text-ink-900 mb-1">Get your personalised referral link</h3>
                <p className="text-sm text-ink-500 leading-relaxed">You receive a unique link: referaus.com/ref/[yourname]. Share it with clients and they land on a search page pre-filtered to registered providers in their area.</p>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              ...
              <div>
                <h3 className="font-bold text-ink-900 mb-1">Track who your clients connect with</h3>
                <p className="text-sm text-ink-500 leading-relaxed">Your SC dashboard shows how many clients used your referral link and which providers they contacted. Simple, useful, private.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-ink-900 mb-4">You are the most trusted voice in the room</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-5 py-4 border border-line-100">
                <span className="text-sm text-ink-500">NDIS participants in Hunter Region</span>
                <span className="text-lg font-black text-blue-600">15,000+</span>
              </div>
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-5 py-4 border border-line-100">
                <span className="text-sm text-ink-500">Providers who need to be found after July 2026</span>
                <span className="text-lg font-black text-blue-600">Growing</span>
              </div>
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-5 py-4 border border-line-100">
                <span className="text-sm text-ink-500">Days until mandatory registration deadline</span>
                <span className="text-lg font-black text-blue-600">111</span>
              </div>
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-5 py-4 border border-line-100">
                <span className="text-sm text-ink-500">Cost to SC partners</span>
      ...
      <section className="px-4 sm:px-6 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xs text-ink-400 mt-4">No credit card. No obligation. Free forever for Support Coordinators.</p>
        </div>
      </section>
    </div>
  );
